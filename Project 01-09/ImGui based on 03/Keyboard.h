...
namespace DirectX
{
    ...
    public:
        ...
        {
        public:
            State released; //键盘是否释放
            State pressed;  //键盘是否按下
        ...
        // Retrieve the current state of the keyboard  获取每一帧的状态
        State __cdecl GetState() const;

        // Reset the keyboard state  重置键盘状态
        void __cdecl Reset() noexcept;

        // Feature detection  检验键盘是否被连接
